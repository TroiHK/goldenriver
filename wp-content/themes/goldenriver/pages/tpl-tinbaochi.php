...
<div class="section innerpager" id="news-page">
	...
	<ul class="nav nav-tabs text-center news--tab">
		<li role="presentation" class=""><a href="<?php echo  get_permalink( get_page_by_title('Công Ty'))?>">Tin công ty</a></li>
		<li role="presentation" class="active"><a href="<?php echo  get_permalink( get_page_by_title('Báo Chí'))?>">Tin báo chí</a></li>
	</ul>
